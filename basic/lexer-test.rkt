...
(define (lex str)
  ;; brag support comes with apply proc: applies function to input port or string until reaching end,
  ;; then returns all results as a list
  (apply-port-proc basic-lexer str))

;; copied verbatum from beautiful racket - should cover all of the cases!
